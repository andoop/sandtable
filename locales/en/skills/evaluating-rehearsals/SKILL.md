...
description: Use when all parallel implementation rehearsals returned DONE and you must score them objectively and choose the best one to integrate. Routes any remaining anomaly back into the fix-and-re-rehearse loop.
---
